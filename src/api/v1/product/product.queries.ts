...
/** 'GetProductFromNearestStoresWithQuery' parameters type */
export interface IGetProductFromNearestStoresWithQueryParams {
  limit?: NumberOrString | null | void;
  max_distance?: number | null | void;
  offset?: NumberOrString | null | void;
...
/** 'GetProductFromNearestStoresWithQuery' return type */
export interface IGetProductFromNearestStoresWithQueryResult {
  address_created_at: Date;
  address_distance: number | null;
  address_latitude: number | null;
  address_longitude: number | null;
...
/** 'GetProductFromNearestStoresWithQuery' query type */
export interface IGetProductFromNearestStoresWithQueryQuery {
  params: IGetProductFromNearestStoresWithQueryParams;
