/* 
    @name CreateProduct
    @param product -> (display_name, description, price_before, price_after, expiration_date, stock, store_id, category_id, image_id)
*/
...
/* @name GetProductFromNearestStoresWithQuery */
SELECT
    p.id,
    p.display_name,
    p.description,
